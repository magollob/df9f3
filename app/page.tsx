        ...
        >
          ...
          <section className="py-16 md:py-24">
            ...
            <div className="relative">
              ...
              <div
                ref={gamesSliderRef}
                className={`flex overflow-x-auto pb-8 gap-6 snap-x snap-mandatory ${styles.hideScrollbar}`}
              >
          ...
          <section className="py-12 md:py-20 bg-gray-900/50 rounded-3xl">
            ...
            <div className="mb-12 md:mb-16">
              ...
              <div className="md:hidden px-4">
                <div className={`flex overflow-x-auto pb-4 gap-3 snap-x snap-mandatory ${styles.hideScrollbar}`}>
                  {[
                    {
                      name: "Super Nintendo",
